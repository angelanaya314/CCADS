...
#def guardar_dato(nombre_libro, data, name_data):
#    with pd.ExcelWriter(nombre_libro, mode = "a", engine = "openpyxl", if_sheet_exists = "replace") as writer:
#        data = str(data)
#        data.to_excel(writer, sheet_name = name_data)
...
# Meses a proyectar
hoja_0 = "1_Meses"
meses_a_proyectar = worksheets_a_dataframe(nombre_libro, hoja_0)

# Comisiones
hoja_1 = "1_Comisiones"
comisiones = worksheets_a_dataframe(nombre_libro, hoja_1)

# Costos fijos
hoja_2 = "1_CostosFijos"
costos_fijos = worksheets_a_dataframe(nombre_libro, hoja_2)

# Costos fijos totales
hoja_3 = "1_CostosFijosTotales"
costos_fijos_totales = worksheets_a_dataframe(nombre_libro, hoja_3)
...
if option_selected == "Planeación financiera":
    ...
    sidebar.markdown(" ")
    sidebar.markdown(" ")
    sidebar.markdown("<h1 style='text-align: left; color: #195419; font-size: 1.5rem;'>Planeación estratégica financiera</h1>", unsafe_allow_html=True)
    sidebar.markdown("<h1 style='text-align: left; color: #195419; font-size: 1.2rem;'>Membresías a analizar:</h1>", unsafe_allow_html=True)
    sidebar.markdown(" ")
    sidebar.header("`* Básica`")
    sidebar.header("`* Black`")
    sidebar.header("`* Platino`")
    ...
    meses_selected = columna2.radio(" ",(3, 6), horizontal=True)
    ...
    if meses_selected == 6:
        ...
        ba_m1 = colum2.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[0,0], min_value = 0, max_value = 10000, step = 1, key = "ba_m1")
        bl_m1 = colum3.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[0,1], min_value = 0, max_value = 10000, step = 1, key = "bl_m1")
        pl_m1 = colum4.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[0,2], min_value = 0, max_value = 10000, step = 1, key = "pl_m1")
        colum1.markdown("")
        # Mes 2
        colum1.markdown("<h1 style='text-align: right; font-size: 1.5rem;'>Mes 2</h1>", unsafe_allow_html=True)
        ba_m2 = colum2.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[1,0], min_value = 0, max_value = 10000, step = 1, key = "ba_m2")
        bl_m2 = colum3.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[1,1], min_value = 0, max_value = 10000, step = 1, key = "bl_m2")
        pl_m2 = colum4.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[1,2], min_value = 0, max_value = 10000, step = 1, key = "pl_m2")
        colum1.markdown("")
        # Mes 3
        colum1.markdown("<h1 style='text-align: right; font-size: 1.5rem;'>Mes 3</h1>", unsafe_allow_html=True)
        ba_m3 = colum2.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[2,0], min_value = 0, max_value = 10000, step = 1, key = "ba_m3")
        bl_m3 = colum3.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[2,1], min_value = 0, max_value = 10000, step = 1, key = "bl_m3")
        pl_m3 = colum4.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[2,2], min_value = 0, max_value = 10000, step = 1, key = "pl_m3")
        colum1.markdown("")
        # Mes 4
        colum1.markdown("<h1 style='text-align: right; font-size: 1.5rem;'>Mes 4</h1>", unsafe_allow_html=True)
        ba_m4 = colum2.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[3,0], min_value = 0, max_value = 10000, step = 1, key = "ba_m4")
        bl_m4 = colum3.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[3,1], min_value = 0, max_value = 10000, step = 1, key = "bl_m4")
        pl_m4 = colum4.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[3,2], min_value = 0, max_value = 10000, step = 1, key = "pl_m4")
        colum1.markdown("")
        # Mes 5
        colum1.markdown("<h1 style='text-align: right; font-size: 1.5rem;'>Mes 5</h1>", unsafe_allow_html=True)
        ba_m5 = colum2.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[4,0], min_value = 0, max_value = 10000, step = 1, key = "ba_m5")
        bl_m5 = colum3.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[4,1], min_value = 0, max_value = 10000, step = 1, key = "bl_m5")
        pl_m5 = colum4.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[4,2], min_value = 0, max_value = 10000, step = 1, key = "pl_m5")
        colum1.markdown("")
        # Mes 6
        colum1.markdown("<h1 style='text-align: right; font-size: 1.5rem;'>Mes 6</h1>", unsafe_allow_html=True)
        ba_m6 = colum2.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[5,0], min_value = 0, max_value = 10000, step = 1, key = "ba_m6")
        bl_m6 = colum3.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[5,1], min_value = 0, max_value = 10000, step = 1, key = "bl_m6")
        pl_m6 = colum4.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_6.iloc[5,2], min_value = 0, max_value = 10000, step = 1, key = "pl_m6")
        colum1.markdown("")
        ...
        # Mes 1
        colum1.markdown("<h1 style='text-align: right; font-size: 1.5rem;'>Mes 1</h1>", unsafe_allow_html=True)
        ba_m1 = colum2.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_3.iloc[0,0], min_value = 0, max_value = 10000, step = 1, key = "ba_m1")
        bl_m1 = colum3.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_3.iloc[0,1], min_value = 0, max_value = 10000, step = 1, key = "bl_m1")
        pl_m1 = colum4.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_3.iloc[0,2], min_value = 0, max_value = 10000, step = 1, key = "pl_m1")
        colum1.markdown("")
        # Mes 2
        colum1.markdown("<h1 style='text-align: right; font-size: 1.5rem;'>Mes 2</h1>", unsafe_allow_html=True)
        ba_m2 = colum2.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_3.iloc[1,0], min_value = 0, max_value = 10000, step = 1, key = "ba_m2")
        bl_m2 = colum3.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_3.iloc[1,1], min_value = 0, max_value = 10000, step = 1, key = "bl_m2")
        pl_m2 = colum4.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_3.iloc[1,2], min_value = 0, max_value = 10000, step = 1, key = "pl_m2")
        colum1.markdown("")
        # Mes 3
        colum1.markdown("<h1 style='text-align: right; font-size: 1.5rem;'>Mes 3</h1>", unsafe_allow_html=True)
        ba_m3 = colum2.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_3.iloc[2,0], min_value = 0, max_value = 10000, step = 1, key = "ba_m3")
        bl_m3 = colum3.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_3.iloc[2,1], min_value = 0, max_value = 10000, step = 1, key = "bl_m3")
        pl_m3 = colum4.number_input(label = "a", label_visibility = "hidden", value = membresias_proyectadas_3.iloc[2,2], min_value = 0, max_value = 10000, step = 1, key = "pl_m3")
        colum1.markdown("")

        m1_2 = [ba_m1, ba_m2, ba_m3]
        m2_2 = [bl_m1, bl_m2, bl_m3]
        m3_2 = [pl_m1, pl_m2, pl_m3]
        df_membresias_actualizadas = pd.DataFrame(list(zip(m1_2, m2_2, m3_2)), columns = ['Básica','Black','Platino'])
        st.write(" --- ")
    ...
    tasa_inflacion = colum2.slider(label = "a", label_visibility = "hidden", value = float(tasas.iloc[0,0]), min_value = 0.00, max_value = 100.0, step = 1.00, key = "tasa_inflacion")
    colum1.markdown(" ")
    colum1.markdown(" ")
    colum1.markdown(" ")
    colum1.markdown("<h1 style='text-align: right; font-size: 1.2rem;'>Tasa de impuestos</h1>", unsafe_allow_html=True)
    tasa_impuestos = colum2.slider(label = "a", label_visibility = "hidden", value = float(tasas.iloc[1,0]), min_value = 0.00, max_value = 100.00, step = 1.00, key = "tasa_impuestos")
    ...
    ba_precios = colum2.number_input(label = "Membresía básica: ", label_visibility = "visible", value = float(precios.iloc[0,0]), min_value = 0.0, max_value = 1000.0, step = 1.0, key = "ba_precio")
    bl_precios = colum3.number_input(label = "Membresía black: ", label_visibility = "visible", value = float(precios.iloc[0,1]), min_value = 0.0, max_value = 1000.0, step = 1.0, key = "bl_precio")
    pl_precios = colum4.number_input(label = "Membresía platino: ", label_visibility = "visible", value = float(precios.iloc[0,2]), min_value = 0.0, max_value = 1000.0, step = 1.0, key = "pl_precio")
    ...
    ba_com_ven = colum2.number_input(label = "a", label_visibility = "hidden", value = float(comisiones.iloc[0,0]), min_value = 0.0, max_value = 100.0, step = 0.1, key = "ba_com_ven")
    bl_com_ven = colum3.number_input(label = "a", label_visibility = "hidden", value = float(comisiones.iloc[0,1]), min_value = 0.0, max_value = 100.0, step = 0.1, key = "bl_com_vem")
    pl_com_ven = colum4.number_input(label = "a", label_visibility = "hidden", value = float(comisiones.iloc[0,2]), min_value = 0.0, max_value = 100.0, step = 0.1, key = "pl_com_ven")
    colum1.markdown("")
    ...
    ba_com_ref = colum2.number_input(label = "a", label_visibility = "hidden", value = float(comisiones.iloc[1,0]), min_value = 0.0, max_value = 100.0, step = 0.1, key = "ba_com_ref")
    bl_com_ref = colum3.number_input(label = "a", label_visibility = "hidden", value = float(comisiones.iloc[1,1]), min_value = 0.0, max_value = 100.0, step = 0.1, key = "bl_com_ref")
    pl_com_ref = colum4.number_input(label = "a", label_visibility = "hidden", value = float(comisiones.iloc[1,2]), min_value = 0.0, max_value = 100.0, step = 0.1, key = "pl_com_ref")
    colum1.markdown("")
    #--- Comisión financiera ---
    colum1.markdown("<h1 style='text-align: right; font-size: 1.2rem;'>Comisión financiera</h1>", unsafe_allow_html=True)
    ba_com_fin = colum2.number_input(label = "a", label_visibility = "hidden", value = float(comisiones.iloc[2,0]), min_value = 0.0, max_value = 100.0, step = 0.1, key = "ba_com_fin")
    bl_com_fin = colum3.number_input(label = "a", label_visibility = "hidden", value = float(comisiones.iloc[2,1]), min_value = 0.0, max_value = 100.0, step = 0.1, key = "bl_com_fin")
    pl_com_fin = colum4.number_input(label = "a", label_visibility = "hidden", value = float(comisiones.iloc[2,2]), min_value = 0.0, max_value = 100.0, step = 0.1, key = "pl_com_fin")
    colum1.markdown("")
    ...
    ba_com_mkt = colum2.number_input(label = "a", label_visibility = "hidden", value = float(comisiones.iloc[3,0]), min_value = 0.0, max_value = 100.0, step = 0.1, key = "ba_com_mkt")
    bl_com_mkt = colum3.number_input(label = "a", label_visibility = "hidden", value = float(comisiones.iloc[3,1]), min_value = 0.0, max_value = 100.0, step = 0.1, key = "bl_com_mkt")
    pl_com_mkt = colum4.number_input(label = "a", label_visibility = "hidden", value = float(comisiones.iloc[3,2]), min_value = 0.0, max_value = 100.0, step = 0.1, key = "pl_com_mkt")
    colum1.markdown("")
    ...
    if tipo_analisis == "Desglose de costos fijos por membresía":
        ...
        ba_costo_1 = colum2.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[0,0]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "ba_costo_1")
        bl_costo_1 = colum3.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[0,1]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "bl_costo_1")
        pl_costo_1 = colum4.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[0,2]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "pl_costo_1")
        colum1.markdown(" ")
        colum1.markdown(" ")
        
        # Medicina general
        colum1.markdown("<h1 style='text-align: right; font-size: 1.2rem;'>Medicina general:</h1>", unsafe_allow_html=True)
        ba_costo_2 = colum2.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[1,0]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "ba_costo_2")
        bl_costo_2 = colum3.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[1,1]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "bl_costo_2")
        pl_costo_2 = colum4.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[1,2]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "pl_costo_2")
        colum1.markdown(" ")
        colum1.markdown(" ")
        
        # Nutrición
        colum1.markdown("<h1 style='text-align: right; font-size: 1.2rem;'>Nutrición:</h1>", unsafe_allow_html=True)
        ba_costo_3 = colum2.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[2,0]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "ba_costo_3")
        bl_costo_3 = colum3.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[2,1]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "bl_costo_3")
        pl_costo_3 = colum4.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[2,2]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "pl_costo_3")
        colum1.markdown(" ")
        colum1.markdown(" ")

        # Psicología
        colum1.markdown("<h1 style='text-align: right; font-size: 1.2rem;'>Psicología:</h1>", unsafe_allow_html=True)
        ba_costo_4 = colum2.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[3,0]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "ba_costo_4")
        bl_costo_4 = colum3.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[3,1]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "bl_costo_4")
        pl_costo_4 = colum4.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[3,2]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "pl_costo_4")
        colum1.markdown(" ")
        colum1.markdown(" ")
        ...
        ba_costo_5 = colum2.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[4,0]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "ba_costo_5")
        bl_costo_5 = colum3.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[4,1]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "bl_costo_5")
        pl_costo_5 = colum4.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[4,2]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "pl_costo_5")
        colum1.markdown(" ")
        colum1.markdown(" ")
        ...
        ba_costo_6 = colum2.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[5,0]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "ba_costo_6")
        bl_costo_6 = colum3.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[5,1]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "bl_costo_6")
        pl_costo_6 = colum4.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[5,2]), min_value = 0.0, max_value = 10000.0, step = 1.0, key = "pl_costo_6")
        colum1.markdown(" ")
        colum1.markdown(" ")
        ...
        ba_costo_7 = colum2.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[6,0]), disabled = True, min_value = 0.0, max_value = 10000.0, step = 1.0, key = "ba_costo_7")
        bl_costo_7 = colum3.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[6,1]), disabled = True, min_value = 0.0, max_value = 10000.0, step = 1.0, key = "bl_costo_7")
        pl_costo_7 = colum4.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[6,2]), disabled = False, min_value = 0.0, max_value = 10000.0, step = 1.0, key = "pl_costo_7")
        colum1.markdown(" ")

        # Doce meses de sueldo por muerte accidental
        colum1.markdown("<h1 style='text-align: right; font-size: 1.2rem;'>Asistencias y seguros básicos:</h1>", unsafe_allow_html=True)
        ba_costo_8 = colum2.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[7,0]), disabled = True, min_value = 0.0, max_value = 10000.0, step = 1.0, key = "ba_costo_8")
        bl_costo_8 = colum3.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[7,1]), disabled = True, min_value = 0.0, max_value = 10000.0, step = 1.0, key = "bl_costo_8")
        pl_costo_8 = colum4.number_input(label = "a", label_visibility = "hidden", value = float(costos_fijos.iloc[7,2]), disabled = False, min_value = 0.0, max_value = 10000.0, step = 1.0, key = "pl_costo_8")
        colum1.markdown(" ")
        ...
        ba_costos_fijos_totales_inicial = costos_fijos["Básica"].astype(float).sum()
        bl_costos_fijos_totales_inicial = costos_fijos["Black"].astype(float).sum()
        pl_costos_fijos_totales_inicial = costos_fijos["Platino"].astype(float).sum()
        
        ba_costos_fijos_totales_actualizados = colum2.number_input(label = "Membresía básica: ", label_visibility = "visible", value = float(costos_fijos_totales.iloc[0,0]), min_value = 0.0, max_value = 1000.0, step = 1.0, key = "ba_costos_fijos_totales")
        bl_costos_fijos_totales_actualizados = colum3.number_input(label = "Membresía black: ", label_visibility = "visible", value = float(costos_fijos_totales.iloc[0,1]), min_value = 0.0, max_value = 1000.0, step = 1.0, key = "bl_costos_fijos_totales")
        pl_costos_fijos_totales_actualizados = colum4.number_input(label = "Membresía platino: ", label_visibility = "visible", value = float(costos_fijos_totales.iloc[0,2]), min_value = 0.0, max_value = 1000.0, step = 1.0, key = "pl_costos_fijos_totales")
    ...
    st.write(" --- ")
    if resultado == True:
        # Tipo de desglose de costos fijos
        if tipo_analisis == "Desglose de costos fijos por membresía":
        ...
        if meses_selected == 6:
            ...
            guardar_dataframes(nombre_libro, df_membresias_actualizadas, "1_MembresíasProyectadas_3")
        # Otros dataframes
        ...
        libro = load_workbook(nombre_libro)
        hoja_meses = libro["1_Meses"]
        st.write(meses_selected)
        hoja_meses["B2"] = meses_selected
        libro.save(nombre_libro)
        resultado = False
...
#-----------------------------------------------------------------------------------------------------------------------------#
    ...
    meses_seleccionados = meses_seleccionados.iloc[0,0]
    ...
    if meses_seleccionados == 3:
        membresias_proyectadas = pd.read_excel("BD_DocTour.xlsx", sheet_name="1_MembresíasProyectadas_3", index_col=0)
    elif meses_seleccionados == 6:
    ...
    columna1, columna2 = st.columns((2,3))
    tipo_analisis_escenario_1 = columna2.radio(" ",("Análisis por membresía","Análisis general"), horizontal=True, key = "tipo_analisis_escenario_1")
    ...
    df_utilidad_neta_inflacion_mes_1 = pd.DataFrame() 
    df_utilidad_neta_inflacion_mes_1['Utilidades netas mensuales'] = df_un_inflacion_mes_1.iloc[:].to_list()
    ...
    if tipo_analisis_escenario_1 == "Análisis por membresía":
    ...
    columna1, columna2 = st.columns((2,3))
    tipo_analisis_escenario_2 = columna2.radio(" ",("Análisis por membresía","Análisis general"), horizontal=True, key = "tipo_analisis_escenario_2")
    ...
    df_utilidad_neta_inflacion_mes_2 = pd.DataFrame() 
    df_utilidad_neta_inflacion_mes_2['Utilidades netas mensuales'] = df_un_inflacion_mes_2.iloc[:].to_list()
    ...
    if tipo_analisis_escenario_2 == "Análisis por membresía":
    ...
    columna1, columna2 = st.columns((2,3))
    tipo_analisis_escenario_3 = columna2.radio(" ",("Análisis por membresía","Análisis general"), horizontal=True, key = "tipo_analisis_escenario_3")
    ...
    df_aux_3 = df_un_inflacion_mes_3.copy()
    df_utilidad_neta_inflacion_mes_3 = pd.DataFrame() 
    df_utilidad_neta_inflacion_mes_3['Utilidades netas mensuales'] = df_aux_3.iloc[:].to_list()
    ...
    if tipo_analisis_escenario_3 == "Análisis por membresía":
